...
export const purchaseRecordFormValuesSchema =
  purchaseRecordSchema.omit({
    id: true,
  });

export type PurchaseRecord = z.infer<typeof purchaseRecordSchema>;

export type PurchaseRecordApiResponse = z.infer<
  typeof purchaseRecordApiResponseSchema
>;

export type PurchaseRecordFormValues = z.infer<
  typeof purchaseRecordFormValuesSchema
>;